#code from https://medium.com/analytics-vidhya/create-your-own-desktop-pet-with-python-5b369be18868
import pyautogui #remember to install this
import random
...
impath = 'C:\\Users\\Nat\\Documents\\GitHub\\ao3_skins\\cat_copy_from_online\\catsrc\\'
...
# Bind the click event to the close_program function
    label.bind("<Button-1>", close_program)
#idle
    if check ==0:
        frame = idle[cycle]
...
# Function to close the program on click
